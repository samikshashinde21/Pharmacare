  ...
  return (
    <>
      ...
      <Heading as="h4" size="sm" ml={"7rem"} mt="3rem">
        {" "}
        Shop Safely And Worry-Free On Oxanto LifeSciences
      </Heading>
      <Text justifyContent={"center"} textAlign="left" m="1rem 7rem 1rem 7rem">
        Oxanto LifeSciences is a renowned name in the online shopping of Over The Counter
        or healthcare products and other daily essentials. Ordering online on
        Oxanto is convenient, fast and hassle-free; you can avoid the
        ...
        longer burn a hole in your pocket. At Oxanto, you are sure to find
